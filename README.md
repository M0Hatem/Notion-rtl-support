...
To use this style, you must first install the **Stylus** extension. Stylus is a clean, open-source user-style manager.
...
## 🚀 Step 2: Install the Notion RTL Style
...
1. Open the [notion-rtl.user.css](notion-rtl.user.css) file and copy all of its content.
2. Click the **Stylus extension icon** in your browser toolbar.
3. Click **Manage** to open the dashboard.
...
If you wish to modify any alignment rules:
